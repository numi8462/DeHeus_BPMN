...
import {
   ...
   * @typedef {import('diagram-js/lib/i18n/translate/translate.js').default} Translate
   *
   * @typedef {import('diagram-js/lib/features/overlays/Overlays').OverlayAttrs} OverlayAttrs
   *
