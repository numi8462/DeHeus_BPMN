...
import * as replaceOptions from '../replace/ReplaceOptions.js';
 ...
 * @typedef {import('bpmn-js/lib/features/modeling/modeling/Modeling').default} Modeling
 ...
 * @typedef {import('bpmn-js/lib/features/copy-paste/ModdleCopy').default} ModdleCopy
 *
 * @typedef {import('bpmn-js/lib/model/Types').Element} Element
 * @typedef {import('bpmn-js/lib/model/Types').Moddle} Moddle
 *
...
ReplaceMenuProvider.prototype.getPopupMenuEntries = function(target) {
  ...
  // start events inside event sub processes (Should be removed)
